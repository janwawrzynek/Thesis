...
print("Γ_SM @ m_N=0.1 GeV:", gamma_N_to_SM(0.1, mixing_parameter_squared))
...
def gamma_aa_NN(z, m_N, m_a, mixing_parameter_squared, f_a):
    ...
    s_max = np.inf # Safe upper bound where K₁ decays sufficiently
...
#plt.loglog(mass_temp_ratio, gamma_aa_NN_list)
plt.xlim(1e-4, 1e2)
